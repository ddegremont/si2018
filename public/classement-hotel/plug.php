...
<body>
  ...
  <section class="Oneplug">
    ...
    <div class="Oneplug__content">
      <div class="Oneplug__contentParagraph">
        <div class="Oneplug__line"></div>
        <p class="Oneplug__paragraph">
          Deux heures de vol, et nous voilà dépaysés ! Fraîchement débarqués dans l’air doux du Nord du Maroc, on se retrouve plongés dans un monde annexe, où la délicatesse des ouvrages marocains s’accorde en magnifique hôtel aux accents de palais maghrébin.
        </p>
      </div>
