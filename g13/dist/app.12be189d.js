...
elBurger.addEventListener('click', function () {
	if (elHeaderMenu.style.marginTop === "") {
		for (var i = 0; i < elHeaderMenuList.length; i++) {
		...
		id = window.setTimeout(function disappearList() {
			for (var _i = 0; _i < elHeaderMenuList.length; _i++) {
				elHeaderMenuList[_i].style.display = "";
			}
		}, 1000);
		clearTimeout(id);
	}
...
var _burger = require('./src/js/burger.js');

var _burger2 = _interopRequireDefault(_burger);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./src/js/burger.js":56}],72:[function(require,module,exports) {
...
//# sourceMappingURL=/app.12be189d.map