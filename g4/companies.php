...
<section class="twittersection">
    ...
    <div class="twitterContainer">
      <div class="twitter_form_container">
        <form class="form_twitter" action="src/actions/twitter_doCreate.php" method="post">
            <label for="name">name</label>
            <input type="text" name="name">
            <label for="url">url</label>
            <input type="text" name="url">
            <input class="create_twittter_btn" type="submit" value="Create">
        </form>
      </div>
      <div class="twitter_container2">
