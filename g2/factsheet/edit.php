...
<html lang="en" dir="ltr">
    ...
    <section class="AdminEdit">
        ...
        <h2 class="AdminEdit_title">Editer les informations de la fiche pratique</h2>    
        <form enctype="multipart/form-data" action="doedit.php" method="post">
            <input type="hidden" name="factsheet[id]" value="<?=$row["id"]?>">
            <label class="adminEdit_label" for="">Titre</label>
            <input class="adminEdit_input" type="text" name="factsheet[title]" value="<?=$row["title"]?>">
            <label class="adminEdit_label" for="">Catégorie</label>
            <select type="text" class="adminEdit_select" name="factsheet[category]" value="">
                    <option value="Hotel">Hôtel</option>
                    <option value="Bar">Bar</option>
                    <option value="Restaurant">Restaurant</option>
                </select>            <label class="adminEdit_label" for="">Texte</label>
            <textarea class="adminEdit_textarea" name="factsheet[text]" id="" cols="30" rows="10"><?=$row["text"]?></textarea>
            ...
            <div class="adminEdit_inputFile_container">
                <div class="adminEdit_inputFile">
                    <input id="addFile" class="adminEdit_inputFileButton" type="file" name="factsheet[imgfile]" value="">
            ...
            <input class="adminEdit_input" type="text" name="factsheet[alt]" value="<?=$row["alt"]?>"> 
            <label class="adminEdit_label" for="">Note</label>

            <input type="number" min="0" max="10" class="adminEdit_inputNumber" name="factsheet[mark]" value="<?=$row["mark"]?>">
            
            <label class="adminEdit_label" for="">Slug</label>
            <input class="adminEdit_input" type="text" name="factsheet[slug]" value="<?=$row["slug"]?>"> 
