...
<body>
    ...
    <h2 class="adminShow_title">Détails de la compagnie</h2>
    ...
    <img class="adminShow_img" width="50px"    src="../uploads/company/<?php echo $row['id'] . "." . $row['logo']; ?>" alt="">
    <h3 class="adminShow_label">signature</h3>
    <p class="adminShow_text"><?=htmlspecialchars($row['signature'])?></p>
    <h3 class="adminShow_label">twitter account</h3>
    <p class="adminShow_text"><?=htmlspecialchars($row['twitter-account'])?></p>
