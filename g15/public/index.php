...
<head>
  ...
  <link rel="stylesheet" href="/flexboxgrid.2b62e845.css" type="text/css">
  <link href="https://fonts.googleapis.com/css?family=Montserrat:300,400,600" rel="stylesheet">
  <link rel="stylesheet" href="/styles.7a063d46.css">
  <link rel="icon" href="favicon.png">
  <title>Une année de voyages</title>
<script src="/flexboxgrid.2b62e845.js"></script><script src="/styles.7a063d46.js"></script></head>
...
<body>
  <div class="container">
    ...
    <p class="header-baseline">Des voyages testés... Des idées pour partir toute l'année !</p>
    <div class="next-publication">
      <p class="next-title">Prochaine sortie 2018</p>
      <p class="next-H1">MOOK COLLECTOR / APP </p>
    </div>
   <article class="bg-grey-book">
      <img class="book" src="/mook.e43d2833.jpg" alt="mook">
   </article>
   <article class="bg-grey-desc">
      <p class="description-title">Un Mook</p>
      <p class="description">Un mook (contraction de magazine et book) est un ouvrage hybride dont le format se situe entre le magazine et le livre. Il est publié de manière périodique et renferme essentiellement de grands reportages. Il comprend également des dessins et des photos servant à l’illustration des textes.• Un mook annuel à collectionner grâce à sa couverture illustrée, œuvre d'un artiste
      <br>
      <br>
   Des goddies : 5 dessins originaux issus des "illustrateurs voyageurs" de la communauté internationale Urban Sketchers <br><br>
   300 pages de reportages sous forme de "carnets de voyages" <br><br>
   Des destinations testées et approuvées par nos journalistes (pas de mauvaise surprise à l'arrivée !) <br><br>
   40.000 exemplaires vendus en kiosques, librairies et sur notre site <br><br>
   Des fiches pratiques d'exception et détachables.</p>
   </article>
   <article class="bg-grey-fiches">
      <img class="book" src="/letter.26d62a18.png" alt="letter">
   </article>
   <article class="bg-grey-desc">
      <p class="description-title">Des fiches pratiques</p>
      <p class="description">Minutieusement détaillées, elles vous disent tout du voyage décrit dans nos articles : Hôtels, restaurants, boutiques, musée, shopping, The Place to be et aussi quelle est la meilleure compagnie aérienne pour rejoindre par exemple San Francisco, quelles sont les meilleures dates, comment aller à pied de Nob Hill au Golden Gate en passant par des ruelles remplies de street art méconnus du grand public, arriver pile à l'heure pour être dans l'axe du soleil.  Sur le 3ème pilier et réussir à coup sûr la photo du siècle tout en s'émerveillant de la beauté de la Bay... ça, c'est Une Année de Voyages ! Des QR Codes intégrés aux fiches pratiques pour offrir une vitrine extra-large à nos partenaires</p>
   </article>
   <article class="bg-grey-fiches">
      <img class="mobile" src="/iphone-white.7b87cf0b.png" alt="mobile">
   </article>
   <article class="bg-grey-desc">
      <p class="description-title">Une Appli</p>
      <p class="description">Qui supprime l'obsolescence du print... Rien que ça ! Une Année De Voyages est un mook print qui vit simultanément à l’ère du numérique... C'est sur l'application que nos fiches pratiques seront updatées et téléchargeables ! Ainsi Une Année De Voyages devient une sorte de "bible" intemporelle des destinations avec des reportages bénéficiant d'une durée de vie illimitée... Le rêve !
      Qui vous dit, sous forme d'un Quizz fun et personnalisé "Quel voyage êtes-vous ?" dont le résultat renvoie forcément à une destination qui correspond à un de nos articles.</p>
   </article>
   <article class="keyword">
      <div class="keyword-content">
         <span class="number"><strong>11</strong></span>
         <p class="jobs">Reporters<br>Photographes</p>
      </div>
      <div class="keyword-content">
         <span class="number"><strong>130</strong></span>
         <p class="jobs">Destinations</p>
      </div>
      <div class="keyword-content">
         <span class="number"><strong>12,000,000</strong></span>
         <p class="jobs">Pages imprimées</p>
      </div>
      <div class="keyword-content">
         <span class="number"><strong>4211</strong></span>
         <p class="jobs">Photos sélectionnées</p>
      </div>
   </article>
